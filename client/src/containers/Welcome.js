...
function Welcome() {
  ...
  const handleRemoveEmail = (email) => {
    if (participants.includes(email.value)) {
      const cloneParticipants = participants.filter((value) => value !== email.value);
      setParticipants(cloneParticipants);
    }
  }
  ...
  return (
    <>
      <Jumbotron >
        <Container>
          <Row>
            <Col md="auto"><Image src="PlanningPoker.png" /></Col>
            <Col md="auto"><h1>Welcome to Planning Poker</h1></Col>
          </Row>      
        </Container>      
      </Jumbotron>
      <Container>
